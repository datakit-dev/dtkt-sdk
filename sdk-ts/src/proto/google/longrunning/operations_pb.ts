 ...
 */
export const OperationSchema: GenMessage<Operation, {validType: OperationValid}> = /*@__PURE__*/
...
export type GetOperationRequestValid = GetOperationRequest;

/**
 * Describes the message google.longrunning.GetOperationRequest.
 * Use `create(GetOperationRequestSchema)` to create a new message.
 */
export const GetOperationRequestSchema: GenMessage<GetOperationRequest, {validType: GetOperationRequestValid}> = /*@__PURE__*/
...
export type ListOperationsRequestValid = ListOperationsRequest;
 ...
 */
export const ListOperationsRequestSchema: GenMessage<ListOperationsRequest, {validType: ListOperationsRequestValid}> = /*@__PURE__*/
...
export type ListOperationsResponseValid = ListOperationsResponse;
 ...
 */
export const ListOperationsResponseSchema: GenMessage<ListOperationsResponse, {validType: ListOperationsResponseValid}> = /*@__PURE__*/
...
export type CancelOperationRequestValid = CancelOperationRequest;
 ...
 */
export const CancelOperationRequestSchema: GenMessage<CancelOperationRequest, {validType: CancelOperationRequestValid}> = /*@__PURE__*/
...
export type DeleteOperationRequestValid = DeleteOperationRequest;
 ...
 */
export const DeleteOperationRequestSchema: GenMessage<DeleteOperationRequest, {validType: DeleteOperationRequestValid}> = /*@__PURE__*/
...
export type WaitOperationRequestValid = WaitOperationRequest;
 ...
 */
export const WaitOperationRequestSchema: GenMessage<WaitOperationRequest, {validType: WaitOperationRequestValid}> = /*@__PURE__*/
...
export type OperationInfoValid = OperationInfo;

/**
 * Describes the message google.longrunning.OperationInfo.
 * Use `create(OperationInfoSchema)` to create a new message.
 */
export const OperationInfoSchema: GenMessage<OperationInfo, {validType: OperationInfoValid}> = /*@__PURE__*/
