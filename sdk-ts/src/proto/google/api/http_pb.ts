...
export const file_google_api_http: GenFile = /*@__PURE__*/
  fileDesc("");
...
export type HttpValid = Http;

/**
 * Describes the message google.api.Http.
 * Use `create(HttpSchema)` to create a new message.
 */
export const HttpSchema: GenMessage<Http, {validType: HttpValid}> = /*@__PURE__*/
 ...
 */
export const HttpRuleSchema: GenMessage<HttpRule, {validType: HttpRuleValid}> = /*@__PURE__*/
 ...
 */
export const CustomHttpPatternSchema: GenMessage<CustomHttpPattern, {validType: CustomHttpPatternValid}> = /*@__PURE__*/
