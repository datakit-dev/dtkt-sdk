...
export const file_google_api_resource: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_descriptor]);
...
export type ResourceDescriptorValid = ResourceDescriptor;

/**
 * Describes the message google.api.ResourceDescriptor.
 * Use `create(ResourceDescriptorSchema)` to create a new message.
 */
export const ResourceDescriptorSchema: GenMessage<ResourceDescriptor, {validType: ResourceDescriptorValid}> = /*@__PURE__*/
...
export type ResourceReferenceValid = ResourceReference;

/**
 * Describes the message google.api.ResourceReference.
 * Use `create(ResourceReferenceSchema)` to create a new message.
 */
export const ResourceReferenceSchema: GenMessage<ResourceReference, {validType: ResourceReferenceValid}> = /*@__PURE__*/
