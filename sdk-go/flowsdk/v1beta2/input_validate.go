...
func NewInputValidator(input *flowv1beta2.Input) *InputValidator {
	v := &InputValidator{
		input: input,
	}
...
func NewInputValidatorWithResolver(input *flowv1beta2.Input, resolver protoresolve.SerializationResolver) *InputValidator {
	v := &InputValidator{
		input: input,
	}
