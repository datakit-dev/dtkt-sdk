...
import (
	...
	"github.com/datakit-dev/dtkt-sdk/sdk-go/cache/cachetest"
	"github.com/datakit-dev/dtkt-sdk/sdk-go/cache/memory"
...
func TestLRUEviction_AccessOrderMatters(t *testing.T) {
	...
	c.Get(ctx, "a") //nolint:errcheck // only marks "a" recently-used for the LRU eviction assertion below; value not under test here
