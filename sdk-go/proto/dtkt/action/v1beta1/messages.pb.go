...
type Action struct {
	...
	Input *v1beta1.TypeSchema `protobuf:"bytes,4,opt,name=input,proto3" json:"input,omitempty"`
	// Describes the shape of data returned to the user after execution.
	Output        *v1beta1.TypeSchema `protobuf:"bytes,5,opt,name=output,proto3" json:"output,omitempty"`
