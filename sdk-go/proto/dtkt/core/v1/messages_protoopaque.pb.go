...
type FlowRun struct {
	...
	xxx_hidden_Error       *status.Status                     `protobuf:"bytes,12,opt,name=error,proto3"`
	xxx_hidden_Flow        string                             `protobuf:"bytes,5,opt,name=flow,proto3"`
	xxx_hidden_SpecEtag    string                             `protobuf:"bytes,6,opt,name=spec_etag,json=specEtag,proto3"`
	xxx_hidden_Connections map[string]*FlowConnectionMetadata `protobuf:"bytes,7,rep,name=connections,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Inputs      map[string]*anypb.Any              `protobuf:"bytes,8,rep,name=inputs,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ListFlowRunsRequest struct {
	...
	xxx_hidden_OrderBy     *string                `protobuf:"bytes,5,opt,name=order_by,json=orderBy,proto3,oneof"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *ReceiveFlowRunEvent) GetFlowState() *v1beta2.FlowStateEvent {
	if x != nil {
		if x, ok := x.xxx_hidden_Event.(*receiveFlowRunEvent_FlowState); ok {
			return x.FlowState
		}
	}
	return nil
...
func (x *ReceiveFlowRunEvent) SetFlowState(v *v1beta2.FlowStateEvent) {
	...
	x.xxx_hidden_Event = &receiveFlowRunEvent_FlowState{v}
}
...
func (x *ReceiveFlowRunEvent) HasFlowState() bool {
	...
	_, ok := x.xxx_hidden_Event.(*receiveFlowRunEvent_FlowState)
	return ok
}
...
func (x *ReceiveFlowRunEvent) ClearFlowState() {
	if _, ok := x.xxx_hidden_Event.(*receiveFlowRunEvent_FlowState); ok {
		x.xxx_hidden_Event = nil
	}
}
...
func (b0 ReceiveFlowRunEvent_builder) Build() *ReceiveFlowRunEvent {
	...
	if b.FlowState != nil {
		x.xxx_hidden_Event = &receiveFlowRunEvent_FlowState{b.FlowState}
	}
	return m0
}
