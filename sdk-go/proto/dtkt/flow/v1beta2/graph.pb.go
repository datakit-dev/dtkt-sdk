...
type Graph struct {
	...
	ErrorStrategy ErrorStrategy `protobuf:"varint,3,opt,name=error_strategy,json=errorStrategy,proto3,enum=dtkt.flow.v1beta2.ErrorStrategy" json:"error_strategy,omitempty"`
