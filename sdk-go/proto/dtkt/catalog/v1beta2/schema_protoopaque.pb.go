...
type Schema struct {
	...
	xxx_hidden_SchemaId    string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3"`
...
func (b0 Schema_builder) Build() *Schema {
	...
	x.xxx_hidden_SchemaId = b.SchemaId
...
type ListSchemasResponse struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Schemas       *[]*Schema             `protobuf:"bytes,1,rep,name=schemas,proto3"`
...
type CreateSchemaRequest struct {
	...
	xxx_hidden_SchemaId string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3"`
	xxx_hidden_Schema   *Schema                `protobuf:"bytes,3,opt,name=schema,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
