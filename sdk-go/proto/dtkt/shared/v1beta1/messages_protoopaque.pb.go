...
type PageCursor struct {
	...
	xxx_hidden_Values  *[]*PageCursor_CursorValue `protobuf:"bytes,4,rep,name=values,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type PageCursor_CursorValue struct {
	state         protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_V  isPageCursor_CursorValue_V `protobuf_oneof:"v"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PageCursor_CursorValue) GetS() string {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_S); ok {
			return x.S
		}
	}
	return ""
...
func (x *PageCursor_CursorValue) GetI() int64 {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_I); ok {
			return x.I
		}
	}
	return 0
...
func (x *PageCursor_CursorValue) GetF() float64 {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_F); ok {
			return x.F
		}
	}
	return 0
...
func (x *PageCursor_CursorValue) GetB() bool {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_B); ok {
			return x.B
		}
	}
	return false
...
func (x *PageCursor_CursorValue) GetBytes() []byte {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Bytes); ok {
			return x.Bytes
		}
	}
	return nil
...
func (x *PageCursor_CursorValue) GetT() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_T); ok {
			return x.T
		}
	}
	return nil
...
func (x *PageCursor_CursorValue) GetUuid() string {
	if x != nil {
		if x, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Uuid); ok {
			return x.Uuid
		}
	}
	return ""
...
func (x *PageCursor_CursorValue) SetS(v string) {
	x.xxx_hidden_V = &pageCursor_CursorValue_S{v}
}

func (x *PageCursor_CursorValue) SetI(v int64) {
	x.xxx_hidden_V = &pageCursor_CursorValue_I{v}
}

func (x *PageCursor_CursorValue) SetF(v float64) {
	x.xxx_hidden_V = &pageCursor_CursorValue_F{v}
}

func (x *PageCursor_CursorValue) SetB(v bool) {
	x.xxx_hidden_V = &pageCursor_CursorValue_B{v}
}
...
func (x *PageCursor_CursorValue) SetBytes(v []byte) {
	...
	x.xxx_hidden_V = &pageCursor_CursorValue_Bytes{v}
}
...
func (x *PageCursor_CursorValue) SetT(v *timestamppb.Timestamp) {
	...
	x.xxx_hidden_V = &pageCursor_CursorValue_T{v}
}

func (x *PageCursor_CursorValue) SetUuid(v string) {
	x.xxx_hidden_V = &pageCursor_CursorValue_Uuid{v}
}
...
func (x *PageCursor_CursorValue) HasS() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_S)
	return ok
}
...
func (x *PageCursor_CursorValue) HasI() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_I)
	return ok
}
...
func (x *PageCursor_CursorValue) HasF() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_F)
	return ok
}
...
func (x *PageCursor_CursorValue) HasB() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_B)
	return ok
}
...
func (x *PageCursor_CursorValue) HasBytes() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Bytes)
	return ok
}
...
func (x *PageCursor_CursorValue) HasT() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_T)
	return ok
}
...
func (x *PageCursor_CursorValue) HasUuid() bool {
	...
	_, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Uuid)
	return ok
}
...
func (x *PageCursor_CursorValue) ClearS() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_S); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearI() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_I); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearF() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_F); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearB() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_B); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearBytes() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Bytes); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearT() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_T); ok {
		x.xxx_hidden_V = nil
	}
}

func (x *PageCursor_CursorValue) ClearUuid() {
	if _, ok := x.xxx_hidden_V.(*pageCursor_CursorValue_Uuid); ok {
		x.xxx_hidden_V = nil
	}
}
...
func (b0 PageCursor_CursorValue_builder) Build() *PageCursor_CursorValue {
	...
	_, _ = b, x
	if b.S != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_S{*b.S}
	}
	if b.I != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_I{*b.I}
	}
	if b.F != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_F{*b.F}
	}
	if b.B != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_B{*b.B}
	}
	if b.Bytes != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_Bytes{b.Bytes}
	}
	if b.T != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_T{b.T}
	}
	if b.Uuid != nil {
		x.xxx_hidden_V = &pageCursor_CursorValue_Uuid{*b.Uuid}
	}
	return m0
}
